...
public class PlayImageGuessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playimageguess);
    ...
    private void openPlayScore() {
        Intent intent = new Intent(this, PlayScoreActivity.class);
